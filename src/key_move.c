...
void	move_up(t_all *all)
{
	if (all->global.nums[(int)(all->pos.pos_x + all->pos.dir_x
			* all->pos.move_speed)][((int)all->pos.pos_y)] == '0')
		all->pos.pos_x += all->pos.dir_x * all->pos.move_speed;
	if (all->global.nums[((int)all->pos.pos_x)]
		[(int)(all->pos.pos_y + all->pos.dir_x * all->pos.move_speed)] == '0')
...
void	move_right(t_all *all)
{
	...
	if (all->global.nums[(int)(all->pos.pos_y
			+ all->pos.dir_x * all->pos.move_speed)]
			[(int)(all->pos.pos_y)] == '0')
